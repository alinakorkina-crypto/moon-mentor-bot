"""Experimental one-call Reading Engine v3.8 for Moon Mentor.
...
Правила:
- Начинай сразу с ситуации, без приветствия, представления или вводной фразы.
- Первое предложение должно отвечать по существу: назови условие или факт, от
  которого зависит выбор, но не выбирай за человека.
...
- Все карты должны менять общий вывод. Можно назвать их все, но нельзя строить
  ответ как последовательность отдельных значений.

"""Two-scenario preview for Reading Engine v4.1."""

import re

from ai_reader_v41 import ask_gemini_v41
from reading_engine_v41 import generate_reading_v41
...
def main() -> None:
    print("\n===== READING ENGINE V4.1: COMPLETE-PROSE 2-SCENARIO PREVIEW =====\n")
    for index, scenario in enumerate(SCENARIOS, start=1):
        calls = 0
        def one_counted_call(prompt: str) -> str | None:
            nonlocal calls
            calls += 1
            return ask_gemini_v41(prompt)
